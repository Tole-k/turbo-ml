...
def get_iris() -> Tuple[pd.DataFrame, pd.DataFrame]:
    bunch = datasets.load_iris(as_frame=True)
    return bunch['data'], bunch['target']


def get_wine() -> Tuple[pd.DataFrame, pd.DataFrame]:
    bunch = datasets.load_wine(as_frame=True)
    return bunch['data'], bunch['target']


def get_breast_cancer() -> Tuple[pd.DataFrame, pd.DataFrame]:
    bunch = datasets.load_breast_cancer(as_frame=True)
    return bunch['data'], bunch['target']


def get_digits() -> Tuple[pd.DataFrame, pd.DataFrame]:
    bunch = datasets.load_digits(as_frame=True)
    return bunch['data'], bunch['target']


def get_diabetes() -> Tuple[pd.DataFrame, pd.DataFrame]:
...
def get_heart_disease() -> Tuple[pd.DataFrame, pd.DataFrame]:
