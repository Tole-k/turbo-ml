...
class DecisionTreeClassifier(Model):
    ...
    hyperparameters = [
        ...
        {"name": "min_samples_split", "type": "int",
            "min": 2, "max": 10, "optional": False},
        {"name": "min_samples_leaf", "type": "int",
            "min": 1, "max": 10, "optional": False},
        {"name": "min_weight_fraction_leaf",
            "type": "float", "min": 0.0, "max": 0.5, "optional": False},
        {"name": "max_features", "type": "categorical",
            "choices": ["sqrt", "log2"], "optional": False},
        {"name": "max_leaf_nodes", "type": "int",
            "min": 2, "max": 100, "optional": True},
        {"name": "min_impurity_decrease", "type": "float",
            "min": 0.0, "max": 0.5, "optional": False},
        {"name": "ccp_alpha", "type": "float",
            "min": 0.0, "max": 0.5, "optional": False},
    ]
