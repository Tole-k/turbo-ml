...
class HyperTuner:
    ...
    def optimize_hyperparameters(self, model: Model, dataset: Tuple[pd.DataFrame, pd.DataFrame], task: Literal['classification', 'regression'], no_classes: int = None, no_variables: int = None, device: Literal['cpu', 'cuda', 'mps'] = 'cpu', trials: int = 10, thread_num=1) -> dict:
